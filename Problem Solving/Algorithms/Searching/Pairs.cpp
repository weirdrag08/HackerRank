...
// * ALGORITHM =>
// * For every element 'N' we need to find that either (N + k) or (N - k). If either of them exits, then it will have pairs.
// * It can be done in O(n) complexity with the help of hashmap or set (both unordered) which enables us for a O(1) lookup
...
int main(){
    ...
    for(auto x : my_map){                        // * Map traversal
