...
// * 1) Find out the maximum whilst travelling through the numbers and count them if it occurs again during the course of travel.
...
int main(){
    ...
    for(int i = 0; i < n; i++){
        ...
        else if(element == maximum){  // * Whilst traversing the array if we find the current maximum we increment the count by 1
            count++;
        }
    }
